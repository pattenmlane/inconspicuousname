"""
Iteration 1: ATM 5000/5100 bundle vs **per-leg implied vol** (numerical inversion on mids).

Same TTE rule as v0 (hist day d -> TTE = 8-d from round3description). Hedge uses BS delta
at each leg's own IV.

Parameter sweep vs v0: MISPRICE_EDGE=2.5, RV_WINDOW=50 (grid corner).
"""
