"""
Iteration 13: Family10 control — quadratic smile(log-moneyness) plain WLS (non-robust).

Execution remains near v5, but fair-value signal uses plain quadratic smile fit; threshold SHOCK 0.0525 as tuned variant.
"""
