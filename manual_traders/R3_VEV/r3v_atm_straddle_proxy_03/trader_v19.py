"""
Iteration 19: v18 + spread-regime vega floor (data-tied).

Tape: median |ATM bundle - smile_fair| is highest when VEV_5000+VEV_5100 combined L1 spread is tight (ss<=8), and
lower when wide (see analysis_outputs/mispricing_vs_spread_v19.json). So we raise the effective misprice floor in tight
books and relax slightly in wide books, keeping vega+shock gating. TTE: hist day d -> (8-d) days.
"""
...
class Trader:
    def run(self, state: TradingState):
        ...
        mis_floor = VEGA_MISPRICE_BASE + VEGA_MISPRICE_PER_VEGA * vega_ref + spread_adj
