"""
Iteration 20: v19 + straddle-gamma in misprice floor (data-tied).

Subsampled tape (day 0) shows positive corr(|bundle mis|, straddle gamma) ~0.25
(analysis_outputs/mispricing_vs_gamma_straddle_v20.json), so we add a GAMMA_MISPRICE_PER_GAMMA * (g5000+g5100) term
on top of the v19 vega+spread floor. TTE: hist day d -> (8-d) days.
"""
