"""
Iteration 21: v20 + shock-regime quality gating (data-tied).

Round-3 tape analysis (analysis_outputs/shock_nexttick_proxy_regimes_v21.json) shows shock-only entries have better
next-tick proxy when |dS| is larger and ATM combined spread is not wide; wide-book shock trades are net negative.
So keep robust smile family10 core, but require a minimum |dS| for shock-only entries and tighten shock threshold in
wide spread regimes. TTE: hist day d -> (8-d) days.
"""
