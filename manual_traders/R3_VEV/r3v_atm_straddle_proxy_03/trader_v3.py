"""
Iteration 3: ATM 5000/5100 cluster on IV-shock z-score (no identity mispricing term).

Same thesis and products: coordinated 5000/5100 legs + extract delta hedge, with
round3description TTE mapping historical day d -> TTE = 8-d days.
"""
...
class Trader:
    def run(self, state: TradingState):
        ...
        trade_short_bundle = shock_z > IV_SHOCK_Z
        trade_long_bundle = shock_z < -IV_SHOCK_Z
