"""
Iteration 5: Parent v4 (best PnL) with grid corner — tighter ATM spread gate, slightly
lower IV-shock threshold, slightly larger clip. Same ATM 5000/5100 coordinated legs + extract hedge.

TTE: round3description historical day d -> (8-d) days.
Grid vs v4: SHOCK_ABS_EDGE 0.06->0.055, SPREAD_GATE_SUM 10->9, ORDER_CLIP 10->11.
"""
