"""
Iteration 6: Parent v5 grid — slightly more aggressive clip and lower shock threshold.

Same ATM 5000/5100 coordinated legs + extract hedge; TTE hist day d -> (8-d) days.
Grid vs v5: SHOCK_ABS_EDGE 0.055->0.05, ORDER_CLIP 11->12 (optional small MISPRICE relax 3.0->2.8).
"""
