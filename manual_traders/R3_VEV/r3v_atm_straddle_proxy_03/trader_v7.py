"""
Iteration 7: Parent v5 — tighter spread gate only, slightly larger clip.

Grid vs v5: SPREAD_GATE_SUM 9.0->8.5, ORDER_CLIP 11->12; same SHOCK_ABS_EDGE=0.055 and thesis.
TTE: historical day d -> (8-d) days.
"""
