"""
Iteration 8: Parent v5 — one-axis grid: larger clip only.

Same ATM 5000/5100 bundle + extract hedge; TTE d -> (8-d) days.
Grid vs v5: ORDER_CLIP 11->12; all other params match v5 (shock 0.055, spread gate 9).
"""
