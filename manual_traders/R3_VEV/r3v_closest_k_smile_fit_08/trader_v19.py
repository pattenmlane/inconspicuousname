...
SHOCK_REGIME_ALLOW = frozenset({"neutral"})
...
class Trader:
    def run(self, state: TradingState):
        ...
        for k in STRIKES:
            ...
            if du_shock and regime in SHOCK_REGIME_ALLOW and k in SHOCK_CORE_STRIKES:
                raw_edge += 1.0
            elif du_shock and regime in SHOCK_REGIME_ALLOW and k in SHOCK_NEAR_STRIKES:
                raw_edge += 1.0
