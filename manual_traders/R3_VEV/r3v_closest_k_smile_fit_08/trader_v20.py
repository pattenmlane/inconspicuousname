...
lean away from stale-smile pain during re-pricing. Hydrogel/extract base MM unchanged.
"""
...
SHOCK_SIZE_MULT_CORE_STRESSED = 0.96
...
class Trader:
    def run(self, state: TradingState):
        ...
        for k in STRIKES:
            ...
            if du_shock and regime == "neutral" and k in SHOCK_CORE_STRIKES:
                raw_edge += 1.0
            elif du_shock and regime == "neutral" and k in SHOCK_NEAR_STRIKES:
                raw_edge += 1.0
            elif du_shock and regime == "stressed" and k in SHOCK_CORE_STRIKES:
                raw_edge += 1.0
            ...
            if du_shock and regime == "neutral" and k in SHOCK_CORE_STRIKES:
                ...
                size = max(4, int(round(size * SHOCK_SIZE_MULT_CORE_STRESSED)))
