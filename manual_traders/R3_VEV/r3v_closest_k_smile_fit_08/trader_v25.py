"""
vouchers_final_strategy: same as v24 but **only quote when joint gate is on** (Sonic / risk filter).

When either 5200 or 5300 spread > 2, emit no orders (wide = different regime; do not trust flow).
When tight, same MM as v24 tight parameters.
"""
