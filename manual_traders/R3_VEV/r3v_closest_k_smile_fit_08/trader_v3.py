"""
Round 3 VEV: local smile (closest-6) + vega-scaled MM — iteration 3 parameter sweep on v2.

Change vs v2: BASE_EDGE_VEV 2 (was 3) to test tighter default quotes at median ~3-tick
spreads; REFIT_EVERY 50 (was 80) to refit the local surface more often as extract moves.
Same DTE (round3description + intraday wind-down), same S0 anchors for csv_day.
"""
