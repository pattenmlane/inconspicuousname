"""
Round 3 VEV: local smile (closest-5) + vega-scaled MM — iteration 6 grid on v3 (best PnL line).

Sweeps CLOSEST_K=5: slightly tighter local fit than k=6 (between prior k=3 and k=6) while
keeping same vega/edge/REFIT as v3. T/DTE: same as v3. Parent: v3.
"""
