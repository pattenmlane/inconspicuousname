"""
Round 3 VEV: local smile + vega-scaled MM — iteration 7 (random-old parent variant).

Same structure as v3, but CLOSEST_K=4 to probe tighter locality from an older branch of
the k-grid. Keeps DTE mapping and all product scope unchanged.
"""
