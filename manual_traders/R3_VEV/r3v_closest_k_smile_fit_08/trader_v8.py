"""
Round 3 VEV: local smile (closest-6) + vega-scaled MM — iteration 8 (parent: v3).

Grid: REFIT_EVERY=40 (vs v3=50) to refit the local surface slightly more often as spot/vols move,
trading a little extra compute for potentially fresher IV coefficients. All else matches v3.
T/DTE: same as v3; extract open anchors for csv_day unchanged.
"""
