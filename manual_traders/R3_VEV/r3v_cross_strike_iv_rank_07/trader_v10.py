"""
Round 3 — cross-strike IV rank fade (r3v_cross_strike_iv_rank_07), iteration v10.
...
Same as v6 (smile residual rank + neighbor cap 0.12) but ACTION_STRIDE=2 (vs 4) to refresh
IV/rank more often; parameter grid vs v11.
"""
