"""
Round 3 — cross-strike IV rank fade (r3v_cross_strike_iv_rank_07), iteration v11.
...
Same as v6 with BASE_Q=10 and MAX_CLUSTER_Q=25 (v6 uses 8/22); size grid to capture smile residual edge.
"""
