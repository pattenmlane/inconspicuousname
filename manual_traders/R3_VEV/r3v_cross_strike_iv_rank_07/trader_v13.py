"""
Round 3 — cross-strike IV rank fade (r3v_cross_strike_iv_rank_07), iteration v13.
...
Same as v10 with tighter residual neighbor cap and slightly larger size.
"""
