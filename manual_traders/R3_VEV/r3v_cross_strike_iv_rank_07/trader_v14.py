"""
Round 3 — cross-strike IV rank fade (r3v_cross_strike_iv_rank_07), iteration v14.
...
Same as v10 with ACTION_STRIDE=1 (every centisecond bucket after warmup) for maximum
residual-decile refresh; ~2x backtest cost vs v10.
"""
