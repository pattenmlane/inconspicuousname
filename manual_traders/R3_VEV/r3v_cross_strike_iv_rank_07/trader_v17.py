"""
Round 3 — cross-strike IV rank fade (r3v_cross_strike_iv_rank_07), iteration v17.
...
Realized-vol regime variant: regime = EWMA realized vol minus ATM IV, with cooldown=20 ticks and regime-based width/inventory caps. threshold=0.03.
"""
