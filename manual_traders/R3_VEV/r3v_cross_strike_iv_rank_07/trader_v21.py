"""
Round 3 — cross-strike IV rank fade (r3v_cross_strike_iv_rank_07), iteration v21.
...
Propagation-aware directional gate: keep smile-residual decile ranking, but only buy low-residual strikes on up-move or sell high-residual strikes on down-move when strike beta>= 0.35.
"""
