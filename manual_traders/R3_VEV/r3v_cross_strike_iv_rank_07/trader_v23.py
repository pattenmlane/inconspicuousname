"""
Round 3 — r3v_cross_strike_iv_rank_07, iteration v23.

Grid vs v22: same soft beta_t-based size multipliers from historical dP/dS (lag_elasticity analysis),
but NEIGHBOR_LOOSEN_MAX=0 (no widening of the neighbor residual cap for low-beta wings) to isolate
the effect of cap loosening; base cap remains 0.12 as in v14.
