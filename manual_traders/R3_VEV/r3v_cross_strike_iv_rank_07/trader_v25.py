"""
r3v_cross_strike_iv_rank_07, iteration v25.

Grid vs v24: softer microstructure stress (smaller haircuts) to sweep the new knobs:
MOVE_SHRINK=30, SPREAD_KAPPA=0.02, MULT_MOVE_MIN=0.92, MULT_SPREAD_MIN=0.9.
Otherwise identical to v24 (v23 + per-tick |ΔS|/S and L1-spread size scalers).
"""
