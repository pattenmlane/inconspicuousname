"""
Round 3 — r3v_cross_strike_iv_rank_07, iteration v29.

**Hard** joint gate vs v28: same 5200/5300 both spread<=2 test, but **no VEV orders** unless the gate
is on (Sonic/clean-hedge regime). When wide, return empty book updates (residual/sizing unchanged in
code path but inert). No extract overlay.
