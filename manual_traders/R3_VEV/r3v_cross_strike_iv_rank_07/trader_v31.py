"""
r3v_cross_strike_iv_rank_07 — iteration v31.

vouchers_final_strategy — same as v30 (joint 5200+5300 spread<=2 gate, join-bid long extract+VEVs)
with a size grid: larger clip sizes to seek higher PnL under worse fills (still within 200/300 limits).
"""
