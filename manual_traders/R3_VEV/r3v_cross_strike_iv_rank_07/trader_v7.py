"""
Round 3 — cross-strike IV rank fade (r3v_cross_strike_iv_rank_07), iteration v7.
...
Parameters: v1 + smile residual; NEIGHBOR_RESIDUAL_CAP = 0.15 (v6 used 0.12).
"""
