"""
Round 3 — cross-strike IV rank fade (r3v_cross_strike_iv_rank_07), iteration v8.
...
Parameters: same as v6 (smile residual rank) but tighter neighbor cap on residual gaps:
NEIGHBOR_RESIDUAL_CAP = 0.05 (grid vs v9 at 0.08; tape iv_smile_residual_vs_raw p90 ~0.047).
"""
