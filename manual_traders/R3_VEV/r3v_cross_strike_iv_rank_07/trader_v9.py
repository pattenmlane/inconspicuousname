"""
Round 3 — cross-strike IV rank fade (r3v_cross_strike_iv_rank_07), iteration v9.
...
Parameters: same as v6; NEIGHBOR_RESIDUAL_CAP = 0.08 (grid vs v8 at 0.05).
"""
