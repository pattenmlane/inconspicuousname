"""
v10: v4 with faster requotes on all tape days (REQUOTE_EVERY=2 vs 3).

Sweep vs v9 (day-2-only //2): test whether global refresh helps without
over-fitting one day.
"""
