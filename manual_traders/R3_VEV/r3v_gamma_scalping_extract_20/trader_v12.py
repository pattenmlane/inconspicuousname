"""
v12: v4 with tape-day-1 softer extract hedge and same day-2 no-hedge rule.

Motivation from tapes: day-1 extract has upward drift and positive dIV-dS
co-movement, so heavy day-1 delta hedging may donate edge. Sweep lower hedge
fraction and wider band on day 1 only.
"""
