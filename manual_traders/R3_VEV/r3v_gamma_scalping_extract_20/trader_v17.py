"""
v17: v16 inverse on day-1 clip split (test the opposite weighting).

Tape analysis shows higher dOption/dS on the *closer* near strike to extract
( higher delta, higher local beta; see extract_voucher_response.json ). v16
gave the larger clip to the lower-delta leg; v17 gives the larger clip to the
higher-delta (higher extract-beta) leg to lean into the strike that moves more
per extract tick, while using the same 4/6 clip box as v16.
"""
