"""
Gamma-scalping extract v2: two nearest strikes (gamma strip near ATM), wall-mid underlying,
portfolio delta hedge on extract. Sweep vs v1: dual-strike + wall_mid + day-2 wider band.

TTE mapping unchanged: tape days 0,1,2 -> 8,7,6 days (round3description pattern).
"""
...
class Trader:
    def run(self, state: TradingState) -> tuple[dict[str, list[Order]], int, str]:
        ...
        hedge_band = 11 if tape_day == 2 else 6
