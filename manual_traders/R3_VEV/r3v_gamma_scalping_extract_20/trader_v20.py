"""
v20: v17 + lower GAMMA_THRESH on tape day 1 only.

Tape: 20-step extract past/future correlation is positive only on day 1 among
Round-3 CSV days (mild short-horizon continuation), while day 0/2 are not;
this is a regime label, not a hedge rule. We only relax the gamma entry
filter on day 1 to increase near-ATM participation when that regime is active.
"""
