"""Gamma-scalping v3: v2 with tape-day-2 lighter extract hedge (lower frac, larger band)."""
...
class Trader:
    def run(self, state: TradingState) -> tuple[dict[str, list[Order]], int, str]:
        ...
        hedge_band = 14 if tape_day == 2 else 6
        delta_frac = 0.52 if tape_day == 2 else 0.78
        ...
        target_ex = int(round(-delta_frac * portfolio_delta))
