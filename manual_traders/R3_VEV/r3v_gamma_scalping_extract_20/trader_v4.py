"""
v4 experiment (documented): on historical tape day 2 only, skip extract delta hedging —
day-2 backtests showed repeated extract adverse selection vs option edge; we keep
two-strike gamma MM from v2 and accept directional delta on the last tape day.
"""
