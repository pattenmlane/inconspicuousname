"""
Round 3 — inventory vega rail (iteration 11).

Parent: v8. When `switch_mean` is low, Frankfurt’s branch **flattens** the whole
position at the touch — a hidden liquidation/spread cost. **QUIET_FLATTEN=False:**
do not trade in the quiet regime (hold/flat instead of take/stop) to test whether
PnL improves vs always flattening. Same IV gate 0.7 and no extract hedge.
"""
