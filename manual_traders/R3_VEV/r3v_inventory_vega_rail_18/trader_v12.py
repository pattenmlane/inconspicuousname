"""
Round 3 — inventory vega rail (iteration 12).

Parent: v11 (+96). Keep QUIET_FLATTEN=False and add ATM filter\n0.97 <= K/S <= 1.03 to avoid wing liquidation risk while retaining high-switch regime entries.
"""
