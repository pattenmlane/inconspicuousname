"""
Round 3 — inventory vega rail (iteration 13).

Parent: v11 (+96). Keep QUIET_FLATTEN=False and no extract hedge;\nsweep VEGA_RAIL 650 -> 500 to further cap per-strike liquidation notional.
"""
