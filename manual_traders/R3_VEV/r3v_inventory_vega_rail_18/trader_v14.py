"""
Round 3 — inventory vega rail (iteration 14).

Parent: v12 (+130). Same (no quiet flatten, no extract hedge). Wider ATM band sweep:
0.96 <= K/S <= 1.04 to include near-ATM strikes without going to v1-style deep wings.
"""
