"""
Round 3 — inventory vega rail (iteration 15).

Parent: v12 (+130). Same ATM band 0.97-1.03. **VEGA_RAIL** sweep 650 -> 700
(allow slightly larger clips when vega is low, still capped by rail / |pos|).
"""
