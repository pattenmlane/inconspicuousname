"""
Round 3 — inventory vega rail (iteration 22).

Parent: v12 (+130). Tape-driven only: scale THR_OPEN per strike by extract->voucher
beta (extract_move_propagation_by_contract.json): high-beta strikes get *lower*
open threshold (more responsive = take edge sooner); low-beta get higher threshold.
No hard skip (v20 starved fills). Preserves vega rail + no quiet flatten.
"""
