"""
Round 3 — inventory vega rail (iteration 23).

Parent v22: same beta-scaled THR_OPEN, milder clamp (less extreme threshold spread
across strikes). Propagation-based, no hard skip.
"""
