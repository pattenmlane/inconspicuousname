"""
Round 3 — inventory vega rail (iteration 24).

Parent: v22 (+132). Keep beta-scaled THR_OPEN; lower IV_SCALPING_THR to 0.55 to increase main-branch engagement while preserving no-hard-skip propagation logic.
"""
