"""
Round 3 — inventory vega rail (iteration 25).

Parent: v22 (+132). More aggressive participation: IV_SCALPING_THR=0.45 plus slightly wider beta threshold clamp.
"""
