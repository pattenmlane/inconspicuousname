"""
Round 3 — inventory vega rail (iteration 26).

Parent: v25 (+146). Switch gate: IV_SCALPING_THR=0.35, aligned to tape ATM
VEV_5100 switch_ema p90~0.32-0.35 (see atm_switch_ema_5100_by_day.json).
"""
