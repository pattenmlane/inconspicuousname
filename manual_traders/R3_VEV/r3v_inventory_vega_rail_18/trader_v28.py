"""
Round 3 — inventory vega rail (iteration 28).

Parent: v25. Intermediate switch gate: IV_SCALPING_THR=0.40 (above tape p90,
below v25) to test sweet spot.
"""
