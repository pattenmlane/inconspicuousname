"""
Round 3 — joint tight gate, mean reversion on gate legs only (v34).

vouchers_final_strategy: only trade when VEV_5200 and VEV_5300 BBO spreads both <= 2.
Mean reversion **only** on those two products (the surface whose spread you measure for
the gate — inclineGod spread-of-spreads / Sonic clean n). No 5100, no extract, no hydrogel.
"""
