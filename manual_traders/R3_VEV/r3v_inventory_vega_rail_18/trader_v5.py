"""
Round 3 — inventory vega rail (iteration 5).

Same core as v0 (Frankfurt IV scalp + vega rail + extract hedge/MM + hydrogel MM).
Changes: merge orders at identical prices per symbol so hedge + MM do not exceed extract
limits; VEGA_RAIL grid sweep to 750 (between v0 700 and v1 900).
"""
