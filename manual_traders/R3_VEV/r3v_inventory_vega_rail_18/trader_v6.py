"""
Round 3 — inventory vega rail (iteration 6).

Parent: v5 (no extract/hydrogel MM, merge_orders, partial extract hedge only).
Add ATM filter 0.97 <= K/S <= 1.03 (from vega_signal_window_stats: ATM vs wings spread/edge).
VEGA_RAIL=700 grid point. Same TTE/smile as prior.
"""
