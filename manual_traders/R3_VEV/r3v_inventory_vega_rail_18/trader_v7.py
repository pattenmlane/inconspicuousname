"""
Round 3 — inventory vega rail (iteration 7).

Parent: v5. Parameter sweep: IV_SCALPING_THR 0.7 -> 0.55 and THR_OPEN 0.35 -> 0.30
to align with tape distribution (q75 switch ~0.27-0.38 in vega_signal_window_stats)
so the main scalping branch activates more often without opening v1-style deep wings.
"""
