"""
Round 3 — inventory vega rail (iteration 8).

Parent: v5 (best PnL). **No extract delta:** DELTA_HEDGE_FRAC=0 so the thesis is
purely voucher vega_rail + IV scalping; no VELVETFRUIT_EXTRACT taker leg.
"""
