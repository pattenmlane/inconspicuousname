"""
Round 3 — inventory vega rail (iteration 9).

Parent: v5. Narrow sweep: IV_SCALPING_THR=0.65 (between v5 0.7 and v7 0.55), THR_OPEN=0.32
to slightly relax entry vs v5 while staying stricter than v7; keep hedge 0.10.
"""
...
# --- tunables (iteration 9) ---
VEGA_RAIL = 650.0
THR_OPEN = 0.32
THR_CLOSE = 0.0
LOW_VEGA_THR_ADJ = 0.5
IV_SCALPING_THR = 0.65
LOW_VEGA_CUTOFF = 1.0
THEO_NORM_WINDOW = 20
