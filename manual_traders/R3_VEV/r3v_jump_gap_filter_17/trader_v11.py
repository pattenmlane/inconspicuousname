"""
r3v_jump_gap_filter_17 — iteration 11

Parent: v10 (v8 base + late-session VEV entry cutoff).

Grid: move entry cutoff earlier — _VEV_ENTRY_CUTOFF_FRAC 0.70 vs v10’s 0.75 (stop
opening new VEV risk in the last ~30% of the session; exits still allowed).
