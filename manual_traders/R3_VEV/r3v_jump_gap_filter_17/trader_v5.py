"""
r3v_jump_gap_filter_17 — iteration 5

Parameter grid on v4: tighter neighbor residual cap (6.5 vs 8.0) and higher scalp
threshold (0.52 vs 0.42) to cut tail losses when strike structure is less aligned.
Same mean-theo-diff signal, jump pause, hydrogel MM.
"""
