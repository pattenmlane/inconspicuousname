"""
r3v_jump_gap_filter_17 — iteration 8

Parent: v7 hybrid (jump pause, neighbor compress, theo_diff scalp, hydrogel on pause).

Ablate v7's light extract taker on pause (238 extract PnL on day-0; suspected conflict with
VEV/hydrogel path). When paused, only trade hydrogel inside spread — same as v1 inventory
safety around extract, no directional extract orders.

Re-match v4 scalp grid: SCALP_THR 0.42, max clip 22 (v7 used 0.40 / 20).
