"""Family10 v11: dual-cutoff WLS smile in m=log(K/S)/sqrt(T) + v10 execution.

Change vs v10: fit IV = a + b*m + c*m^2 on standardized log-moneyness m (parent-style axis);
residuals and z-score on averaged price error vs the two cutoffs' fair prices.
Keeps v10's EWMA on residual, agreement filter, OPEN_Z/CLOSE_Z, EDGE_SCALE sizing, beta hedge.
"""
