"""v33 + vega–spread cross-section offsets: within-tick corr(vega@model_iv, top spread) ~ -0.45; widen wings / tighten OTM where book is structurally tight vs pool."""
...
# mean_spread_minus_pool_by_voucher from analysis_outputs/spread_vega_crosssection_summary.json
_RAW_OFF = {
...
class Trader(_mod.Trader):
    ...
    VEV_HALF_LOCAL_ADD_MAP = _RAW_OFF
    VEV_HALF_LOCAL_ADD_SCALE = 0.07
