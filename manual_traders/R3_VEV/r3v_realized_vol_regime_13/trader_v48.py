"""Tight gate loose-side only: when 5200/5300 NOT both <=2, cut size and widen (risk-off). When joint tight, use baseline v33 multipliers 1.0. No hydrogel."""
...
class Trader(_mod.Trader):
    ...
    TIGHT_GATE_LOOSE_VEV_SIZE_MULT = 0.85
    TIGHT_GATE_LOOSE_EX_SIZE_MULT = 0.85
