"""
v16: propagation-analysis pass on top of v15.

Priority analysis (iter 16) on contract-by-contract propagation found strong
next-tick option response to underlying moves across strikes, but implementing
entry-size asymmetry by latest dS sign did not improve realized PnL under
`--match-trades worse` versus v15. Best tested asymmetry was effectively neutral
(boost/cut close to 1.0), tying v15.

Shipped v16 as the tie-best, simpler variant (same logic/params as v15):
log-IV rolling z on VEV_5000 + dynamic entry spread cap after extract drop +
vega-graded clip sizing.
