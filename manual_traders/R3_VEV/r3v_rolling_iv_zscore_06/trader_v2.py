"""
v2: Past-only rolling IV z (v1 signal) without extract hedge.

Adds microstructure: only trade VEV_5000 when top-of-book spread is tight
(<= 5 seashells). Entry hysteresis: require |z| to exceed Z_ENTRY by HYST
vs previous z so we do not churn on noise.

Parameter point (grid label "tight_spread_longshort"): symmetric fade like v0
but with cleaner z and filters.
"""
