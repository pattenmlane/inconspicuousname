"""
v3: Grid point "long_vol_only" — buy voucher on very negative rolling IV z,
flatten toward neutral. No short-vol leg (avoids unbounded loss on rallies).

Same BS IV / past-only window as v2; wider spread cap for entries.
"""
