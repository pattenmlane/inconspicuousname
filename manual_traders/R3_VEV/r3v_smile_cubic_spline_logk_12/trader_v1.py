"""
Round 3 VEV (v1): same as v0 but **IV smile + BS fair use the live extract wall mid** each tick.
Smoothed `_fex` is kept only for extract/hydrogel cash MM, so spline IVs align with option mids.
