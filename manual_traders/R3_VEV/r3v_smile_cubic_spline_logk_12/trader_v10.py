"""
Round 3 VEV (v10): **trader_v9** + delta-cap-aware sizing. Same leave-one-out spline IV
fair per strike, with order size reduced as option delta exposure nears per-symbol limits
(particularly for non-4000 strikes that showed weaker edge in analysis).
