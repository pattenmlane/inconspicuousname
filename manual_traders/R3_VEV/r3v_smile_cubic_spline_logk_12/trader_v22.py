"""
Round 3 VEV (v22): same as v21 with stronger directional take-edge asymmetry.

v21 uses ASYM_EDGE_K=0.20, v22 uses 0.35 as a parameter sweep.
Directional adjustment is applied to TAKE_EDGE only using latest extract move sign.
