"""
Round 3 — vouchers_final_strategy (v27): like v25 but **fair = arithmetic BBO mid**
((bid+ask)/2) to match STRATEGY/mid_price panel, not wall_mid (which blocks taking).

Joint 5200/5300 gate + local spread penalty. VELVET + VEVs only.
"""
