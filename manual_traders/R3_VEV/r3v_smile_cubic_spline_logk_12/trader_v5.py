"""
Round 3 VEV (v5): parent **trader_v1** (best PnL so far) with **vega+spread–aware** take/make
edges: tighten quotes when |vega| is large and/or spread is tight (more confidence in
spline-mid), widen slightly when illiquid. Same cubic-spline IV(log K) fair.
