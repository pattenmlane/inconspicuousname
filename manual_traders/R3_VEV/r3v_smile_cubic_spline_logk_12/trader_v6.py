"""
Round 3 VEV (v6): same as **trader_v5** with a **slightly stronger** vega–spread edge scaling
(VEGA_EDGE_SCALE 0.25 vs 0.15) — small parameter grid between v5 and v6.
