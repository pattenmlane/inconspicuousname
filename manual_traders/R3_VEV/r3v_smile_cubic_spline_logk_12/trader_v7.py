"""
Round 3 VEV (v7): **trader_v5** + **BS gamma** in the edge rule: at high |γ| the fair moves
faster in price space for a 1-tick S move, so we **add** required edge (less aggressive)
on top of the v5 vega+spread adjustment. Same cubic-spline IV(log K) fair.
