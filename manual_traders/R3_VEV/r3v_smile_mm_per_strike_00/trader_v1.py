"""
Round 3 — same thesis as trader_v0 (smile-fitted BS fair, inventory skew, wing width),
with **EMA-smoothed smile coefficients** in traderData to reduce jump-to-jump fair
volatility, slightly wider extract quotes and smaller extract clip.

See trader_v0.py header for DTE/TTE and symbol conventions.
"""
...
# EMA on (c,b,a) smile polynomial — lower = smoother fairs
