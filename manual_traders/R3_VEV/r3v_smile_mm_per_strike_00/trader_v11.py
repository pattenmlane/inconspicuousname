"""
Round 3 — **Frozen copy of trader_v9** after iteration-11 parameter checks.

Local sweeps on this branch (extract hedge beta, EXTRACT_HALF, BASE_HALF_SPREAD on
days 0–1, and sqrt weighting in the smile fit) did not beat v9’s aggregate PnL on the
default round-3 backtest. **Logic matches trader_v9**; this file is the labeled “best
stable” copy for the next iteration’s parent.
