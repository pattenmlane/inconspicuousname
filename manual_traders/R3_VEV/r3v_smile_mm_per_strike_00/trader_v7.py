"""
Round 3 — **trader_v6** (smile MM + no extract/hydrogel on csv_day 2) with **EMA-smoothed
quadratic smile coefficients (c,b,a)** in traderData to slow intraday re-pricing of the
fitted IV surface (reduces whipsaw when mids jump).

EMA logic matches **trader_v1**; alpha and store key are tunable below.

Parent: trader_v6 (best PnL so far in this run).
"""
