"""
v1: Same PWL IV smile as v0; skip deep OTM / wing strikes (4000,4500,6000,6500) where BS+IV is
noisy; require spread >= 2; merge duplicate price levels; slightly higher IV-scalp gates; cap
size when vega is tiny.
"""
...
TRADE_STRIKES = (5000, 5100, 5200, 5300, 5400, 5500)
...
THR_OPEN = 0.58
THR_CLOSE = 0.08
LOW_VEGA_THR_ADJ = 0.55
LOW_VEGA_CUTOFF = 0.85
THEO_NORM_WINDOW = 28
IV_SCALPING_WINDOW = 110
IV_SCALPING_THR = 0.62
WARMUP_STEPS = 12
MIN_SPREAD = 2
VEGA_CAP_QTY = 22
...
class Trader:
    def run(self, state: TradingState):
        ...
        for k, sym in zip(STRIKES, VOUCHERS):
            ...
            cap = VEGA_CAP_QTY if vega < 0.55 else LIMIT_VEV
            ol: list[Order] = []
