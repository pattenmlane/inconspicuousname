"""
v2: PWL IV smile (knots 5000/5200/5400) + IV scalping. Skip only VEV_4000/4500 (v0 loss sink);
merge duplicate price levels; slightly higher open threshold; cap size on high wings when vega<0.5.
"""
...
SKIP_TRADE_STRIKES = frozenset({4000, 4500})
WING_STRIKES = frozenset({6000, 6500})
...
class Trader:
    def run(self, state: TradingState):
        ...
        for k, sym in zip(STRIKES, VOUCHERS):
            ...
            cap = WING_CAP if k in WING_STRIKES and vega < 0.5 else LIMIT_VEV
            ol: list[Order] = []
