"""
v26: v23 + strike-specific spread floors (5000>=5, 5100>=4, 5200>=3, 5300>=2) while keeping same PWL/IV logic.
"""
...
WING_CAP = 40
STRIKE_5000_CAP = 1
SPREAD_FLOOR = {5000: 5, 5100: 4, 5200: 3, 5300: 2}
...
class Trader:
    def run(self, state: TradingState):
        ...
        for k, sym in zip(STRIKES, VOUCHERS):
            ...
            floor = int(SPREAD_FLOOR.get(k, 3))
            if spread < floor:
                continue
