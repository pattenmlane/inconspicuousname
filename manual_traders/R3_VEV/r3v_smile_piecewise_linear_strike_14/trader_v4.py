"""
v4: v3 + skip VEV_5000 (dominant loss in v3 backtest); slightly stricter switch_mean gate.
"""
...
SKIP_TRADE = frozenset({4000, 4500, 5000})
...
THR_OPEN = 0.48
THR_CLOSE = 0.06
LOW_VEGA_THR_ADJ = 0.46
LOW_VEGA_CUTOFF = 1.15
THEO_NORM_WINDOW = 25
IV_SCALPING_WINDOW = 105
