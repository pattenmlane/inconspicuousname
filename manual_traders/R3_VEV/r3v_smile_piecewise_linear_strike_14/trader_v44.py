"""
v41 + skip VEV_5400. Tape PWL misfit (mid - BS(PWL)): VEV_5400 shows large negative
median bias all days (~2.5-3 ticks vs ~0 at 5200) -> three-knot smile is a poor map
at 5400; avoid trading it.
"""
...
SKIP_TRADE = frozenset({4000, 4500, 5400})
