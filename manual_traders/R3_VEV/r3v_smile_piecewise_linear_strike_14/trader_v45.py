"""
v44 grid: also skip VEV_5500 (tape PWL misfit flips sign by day at 5100/5300; 5500 is
low-delta wing with noisy fit — ablation vs v44).
"""
...
SKIP_TRADE = frozenset({4000, 4500, 5400, 5500})
