"""
Round-3: vouchers_final_strategy only (no legacy PWL / smile thesis).

- Joint gate: VEV_5200 and VEV_5300 L1 spread (ask1-bid1) both <= 2 (STRATEGY.txt, Sonic
  in ORIGINAL_DISCORD_QUOTES.txt; inclineGod: use spreads, not just price correlation).
- Tight: long extract + 5200/5300 on positive EMA of tick d(mid); inverse on negative.
- Wide: reduce extract / core VEV size (hedge-into-tight-surface: do not add noise).
