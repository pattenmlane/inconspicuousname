"""
v54 grid: slightly easier to fire (lower momentum) and more size; same passive 1-tick
inside BBO in joint-tight gate.
"""
    ...
    def run(self, state: TradingState):
        ...
        if tight:
            if ema_m > MOMENTUM_LONG and p_u < LIM_U - Q_EXTRACT:
                ...
                add(U, [Order(U, px, min(Q_EXTRACT, LIM_U - p_u))])
