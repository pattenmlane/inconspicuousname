"""
Iteration 11: parent v9; parameter sweep only: _THETA_REF 1200 -> 1000 (slightly stronger
theta sensitivity in theta_edge_multiplier). Same WLS smile, BS fair, touch cross.
"""
