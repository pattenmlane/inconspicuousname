"""
Iteration 15: parent v10. Ablation: blend mid and L1 microprice for edge only:
mark = 0.75*mid + 0.25*micro (see microprice_smile_mispricing_iter14.json). Same
theta+spread gates and touch crossing as v10.
"""
