"""
Iteration 16: parent v15. Data-grounded ablation from microprice_predictive_iter16:
revert edge mark to plain mid (no microprice blend) while preserving the same
WLS smile fair, theta+spread gate multipliers, and touch-cross execution.
"""
