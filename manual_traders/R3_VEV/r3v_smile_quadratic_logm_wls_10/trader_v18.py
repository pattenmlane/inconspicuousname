"""
Iteration 18: parent v15. Data-grounded filter from extract_propagation_spread_iter17:
tape OLS beta of voucher mid change vs extract mid change is ~0 for VEV_6000 and
VEV_6500 (deep OTM; spread stuck at 1 tick). Skip trading those symbols; keep
WLS smile fit and execution otherwise identical to v15.
"""
...
# No extract pass-through on tape (beta ~0); book always 1-wide — illiquid mispricing noise.
