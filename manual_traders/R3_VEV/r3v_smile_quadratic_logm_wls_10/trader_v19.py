"""
Iteration 19: parent v15. Keep v15 signal stack, but add a narrow
extract-shock tail gate from shock_regime_gate_iter19:
only when |dS| is in the top tail (>=2.0 extract points, ~top 8% on tape),
apply stricter entry thresholds and smaller clips.
"""
