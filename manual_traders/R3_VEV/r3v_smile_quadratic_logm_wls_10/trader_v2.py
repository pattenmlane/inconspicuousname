"""
Iteration 2: same quadratic smile + ridge; fix fill realism — passive limits below ask rarely
match in prosperity4bt. When edge vs BS(fitted IV) exceeds threshold, cross at touch:
buy at best_ask (undervalued), sell at best_bid (overvalued). Moderate thresholds; clip by vega tier.
"""
