"""
Iteration 25 — same as v23 (joint 5200+5300 <=2, one-tick MM, no taker, no
legacy smile). v24 showed naive EMA+taker on extract is catastrophic under
worse; v25 only scales size when gate is on (STRATEGY: size up in tight regime).
