"""
Iteration 3: touch-crossing like v2; reduce early-day noise — use pooled prior coeffs only
for the first ~120 book steps before trusting online ridge; require spread>=2 on VEV;
slightly higher edge fraction; smaller clips when vega<0.1.
"""
