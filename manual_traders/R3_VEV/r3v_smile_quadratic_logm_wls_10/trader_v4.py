"""
Iteration 4: same WLS quadratic-IV smile thesis.
- Keep BS fair from sigma(m) with online ridge + pooled prior.
- Add strike-selective execution and vega-normalized edge gate from tape analysis.
"""
