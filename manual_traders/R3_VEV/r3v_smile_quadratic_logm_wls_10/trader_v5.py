"""
Iteration 5: same WLS quadratic-IV smile + BS fair, with a narrow parameter sweep from v4:
- Slightly stricter edge fraction and vega-normalized edge gate.
- Keep core strikes focus and touch-cross execution.
"""
