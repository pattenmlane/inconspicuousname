"""
Round 3 — sticky EWMA smile (same core as v1) + **liquidity filter**: skip passive quotes when
top-of-book half-spread is wide unless |mid − BS(sticky_iv)| exceeds a strike-aware threshold
(grounded in analysis_outputs/smile_vega_spread_summary.json wing spreads).
"""
...
# (strike,): if half_spread >= hs, need |edge| >= mult * half_spread to quote
