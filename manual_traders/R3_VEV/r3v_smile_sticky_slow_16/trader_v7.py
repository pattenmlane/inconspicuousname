"""
Round 3 — v2 (sticky EWMA smile + wing liquidity filter) with **slower** smile-coeff EMA.

Only change vs trader_v2: EWMA_ALPHA 0.045 -> 0.03 so the quadratic IV(m_t) coefficients
update more slowly; underlying mid for IV/fair is still the tick (see analysis:
smile_ewma_fair_drift_5200.json for motivation).

DTE: round3work/round3description + intraday winding (dte_effective as in v2).
"""
