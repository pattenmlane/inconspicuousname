"""
Round 3 — v2 (sticky EWMA smile + wing filter) with **BS gamma**-aware quote widening.

Idea: when smile IV is held sticky, fair is still concave in S; high call gamma
means small S moves pass through more to the option, so we widen by a modest
0.15 * (gamma / GAMMA_REF) added to the half-spread shift. GAMMA_REF ≈ tape median
