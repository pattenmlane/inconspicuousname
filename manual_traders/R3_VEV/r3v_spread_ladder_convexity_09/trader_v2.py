"""
v2: tape showed fewer false entries at z>2.25 vs 2.0 but v1's bump filter killed days 1–2.
Use z thresholds between v0/v1, no bump gate, clip 10, and passive one-tick improvement
when spread allows (sell wings at ask-1, buy body at bid+1).
"""
