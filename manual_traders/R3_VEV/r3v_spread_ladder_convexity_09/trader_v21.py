"""
Family13 v15 + joint tight two-leg gate — **gate-only** (ablation of v20).

Same spread gate and calm clip/rail multipliers as v20, but **no** VELVETFRUIT_EXTRACT
orders. STRATEGY.txt warns that mid forward-return evidence need not carry through to
passive bid/ask PnL; this tests whether the joint gate helps **only** via VEV sizing.
"""
