"""
v4: same strategy concept (fade rich 5000-5100-5200 convexity fly) with
parameters chosen from a local sweep around v3:
  Z_HI=2.2, Z_LO=0.8, BF_WINDOW=400, CLIP_QTY=10.

IV/Greek thread remains in analysis; execution remains passive one-tick improvement.
"""
