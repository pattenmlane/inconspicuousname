"""
v5: same 5000-5100-5200 convexity-fade as v4; backtester grid (parent v4) best was
lowering the entry z slightly for more good fills:
  Z_HI=2.15, Z_LO=0.8, BF_WINDOW=400, CLIP_QTY=10.
