"""
v6: parent v5; backtest grid around v5 found CLIP_QTY=8 improves total PnL vs 10
(smaller fly size under worse-match slippage).

  Z_HI=2.15, Z_LO=0.8, BF_WINDOW=400, CLIP_QTY=8.
