"""
v7: parent v6; local grid nudged CLIP to 7 (vs 6’s 8) for a bit less slippage per leg
at worse-match, without widening z bands.

  Z_HI=2.15, Z_LO=0.8, BF_WINDOW=400, CLIP_QTY=7.
