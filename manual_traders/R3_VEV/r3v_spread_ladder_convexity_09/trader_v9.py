"""
v9: parent v8; same convexity-fade thesis. Local grid around v8 found CLIP_QTY=5
improves aggregate PnL vs 6/7 at the same z/window.

  Z_HI=2.15, Z_LO=0.8, BF_WINDOW=400, CLIP_QTY=5.
