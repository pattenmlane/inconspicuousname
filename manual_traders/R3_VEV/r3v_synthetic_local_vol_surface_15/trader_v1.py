...
Iteration 1 (grid vs v0): lower residual hurdle and slightly smoother spline to reduce churn;
smaller clip size on aggressive quotes.

Concept unchanged: smooth σ̂(log K) slice vs mid residual vs spread hurdle (worse fills).
"""
...
RESID_HURDLE_MULT = 1.22
SPLINE_SMOOTH = 0.12
MAX_ORDER_PER_VOUCHER = 14
WARMUP_TICKS = 30
POS_VEV = 300
IV_NEWTON_ITERS = 10
