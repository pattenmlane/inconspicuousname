...
Concept: same synthetic local-vol slice thesis, but with a small strike-quality gate and
vega-aware hurdle:
- fit smooth σ̂(log K) each tick from all valid knots;
- trade only strikes showing stronger residual signal on historical tapes;
- require larger residual for high-vega options to avoid over-trading noisy rich/cheap marks.
"""
...
RESID_HURDLE_MULT = 1.35
SPLINE_SMOOTH = 0.08
MAX_ORDER_PER_VOUCHER = 18
WARMUP_TICKS = 30
POS_VEV = 300
IV_NEWTON_ITERS = 10
ALLOWED_STRIKES = {5000, 5100, 5200, 5300, 5400, 5500}
VEGA_HURDLE_COEF = 0.0015
