...
v24: same family12 uniform spline as v19, but trade only highest signal-propagation strikes (5000,5100,5200) from shock_conditional_residual_edge analysis; execution logic otherwise unchanged.
"""
...
POS_VEV = 300
IV_NEWTON_ITERS = 10
ALLOWED_STRIKES = {5000, 5100, 5200}
