...
v25: parent v24 + Greek/residual tape filter: drop VEV_5200 — v24_strike_greeks_iv_extract.json shows
mean_abs_resid/hsp for 5200 far above 5000/5100 on all days (often >1 vs ~0.15–0.54), so 5200 is the
noisiest leg of the subset; trade only 5000 and 5100 with unchanged spline and hurdle logic.
"""
