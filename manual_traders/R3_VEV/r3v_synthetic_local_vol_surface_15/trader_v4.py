...
Concept: same as v3, but the cubic spline is fit **only on the allowed strike set** (not on
wings) so the local-vol slice matches the book where we actually trade, reducing
cross-strike contamination from 4000/4500/6000/6500 knots.
"""
