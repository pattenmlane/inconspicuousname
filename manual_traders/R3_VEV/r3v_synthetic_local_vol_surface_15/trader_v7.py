...
Concept (v7, parent v6 sweep): identical to v6 except **milder** wing down-weight
(WING_SPLINE_WEIGHT 0.65 vs 0.35) in the WLS IV spline; still 10-knot context + allowed-strike
trades only.
"""
