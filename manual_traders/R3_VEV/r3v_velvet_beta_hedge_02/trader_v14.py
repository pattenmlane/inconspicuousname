"""
r3v_velvet_beta_hedge_02 — iteration 14 (parent: v12).

Stronger spread dampening on tilt when book is wide (two-tier multipliers tightened vs v12).
"""
...
class Trader:
    ...
    SPREAD_TILT_CUT1 = 2
    SPREAD_TILT_CUT2 = 5
    SPREAD_TILT_MULT1 = 0.86
    SPREAD_TILT_MULT2 = 0.72
