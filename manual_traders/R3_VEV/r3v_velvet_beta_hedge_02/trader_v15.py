"""
r3v_velvet_beta_hedge_02 — iteration 15 (parent: v12).

Same spread-aware tilt; smaller VEV/hydrogel clip sizes to reduce adverse selection on day 2.
"""
...
class Trader:
    ...
    VEV_SIZE = 17
    HYDRO_SIZE = 10
    # spread_w = (ba2-bb2); mult = 1 if spread_w<=2 else 0.88 if <=5 else 0.75
    SPREAD_TILT_CUT1 = 2
    SPREAD_TILT_CUT2 = 5
    SPREAD_TILT_MULT1 = 0.88
    SPREAD_TILT_MULT2 = 0.75
