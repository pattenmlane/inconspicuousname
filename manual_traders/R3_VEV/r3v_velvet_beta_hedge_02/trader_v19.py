"""
r3v_velvet_beta_hedge_02 — iteration 19 (parent: v17).

Three-tier spread dampening tuned from spread-bucket volatility stats.
"""
...
class Trader:
    ...
    SPREAD_TILT_MULT2 = 0.68
    SPREAD_TILT_MULT3 = 0.56
