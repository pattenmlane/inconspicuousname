"""
r3v_velvet_beta_hedge_02 — iteration 23 (parent: v20).

Same spread multipliers as v20, but start third bucket at spread>7 (CUT3=7 instead of 8).
"""
...
class Trader:
    ...
    SPREAD_TILT_MULT2 = 0.66
    SPREAD_TILT_MULT3 = 0.54
