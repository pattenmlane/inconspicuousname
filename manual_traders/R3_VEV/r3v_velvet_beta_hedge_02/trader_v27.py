"""
r3v_velvet_beta_hedge_02 — iteration 27 (parent: v22).

Strike-specific tilt scale from estimated underlying->voucher beta_0 and spread-shock response.
"""
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for v in VOUCHERS:
            ...
            if ss > 0:
                resp *= 0.88
            sh = int(round((tilt_px * resp) * sc * sm))
            base_bid = bb2 + 1
            base_ask = ba2 - 1
