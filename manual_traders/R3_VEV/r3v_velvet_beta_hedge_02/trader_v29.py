"""
r3v_velvet_beta_hedge_02 — iteration 29 (parent: v22).

Micro-tune: nudge TILT_AMP and W_Z; slightly looser spread multipliers
(0.85/0.65/0.53) between v20 and v22 to probe the dampening Pareto border.
"""
...
class Trader:
    ...
    SPREAD_TILT_CUT2 = 5
    SPREAD_TILT_CUT3 = 8
    SPREAD_TILT_MULT1 = 0.85
    SPREAD_TILT_MULT2 = 0.65
    SPREAD_TILT_MULT3 = 0.53
