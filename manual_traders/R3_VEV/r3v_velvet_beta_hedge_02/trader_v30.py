"""
r3v_velvet_beta_hedge_02 — iteration 30 (parent: v22).

Slightly more mean-reversion in the extract signal: lower TILT_AMP, higher W_Z
(higher weight on 20-tick z), same spread-dampening ladder as v22.
"""
