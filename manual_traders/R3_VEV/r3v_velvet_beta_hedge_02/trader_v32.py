"""
r3v_velvet_beta_hedge_02 — iteration 32 (parent: v22).

Same 5200/5300 tight-gate as v31 plus v9-style inventory skew (sh -= round(pos/120)).
"""
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for v in VOUCHERS:
            ...
            inv0 = int(pos.get(v, 0))
            sh -= int(round(inv0 / float(self.INV_SKEW_DIV)))
            base_bid = bb2 + 1
            base_ask = ba2 - 1
