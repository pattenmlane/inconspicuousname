"""
vouchers_final_strategy — v38 (parent v37).

Same soft joint BBO gate (5200+5300 <= TH) for size regime; no hydrogel.
Scale-up: higher base sizes and slightly stronger tight mult to push VEV+U PnL within limits.
"""
