"""
r3v_velvet_beta_hedge_02 — iteration 4.

Combine v1-style hydrogel MM with v2-style one-tick-inside VEV quotes + integer vega-scaled
tilt (covers all strikes). Parameter sweep: moderate TILT_AMP, VEV_SIZE 19.
"""
