"""
r3v_velvet_beta_hedge_02 — iteration 7.

All-strike tilt with stronger z weight and adaptive VEV size by spread bucket; hydrogel disabled.
"""
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for v in VOUCHERS:
            ...
            p0 = int(pos.get(v, 0))
            lim = LIMITS[v]
            spread_bucket = max(1, ba2 - bb2)
            size = self.VEV_SIZE + (4 if spread_bucket <= 2 else (2 if spread_bucket <= 4 else -2))
