"""
Round 3 velvet spike playbook v0: on large |ΔS| or z-score of extract moves, temporarily
lower IV-scalp open thresholds (burst); otherwise raise them (tight smile MM). Uses
Frankfurt-style smile IV + BS greeks; TTE from csv_day + intraday wind (see analysis.json).

Products: VELVETFRUIT_EXTRACT + all VEV_* (HYDROGEL_PACK not traded in v0).
"""
...
# --- Spike playbook parameters (v0 grid center) ---
# IV_SCALPING_THR gates the Frankfurt branch; tape EMA avg_devs rarely exceeds ~0.55 (see analysis).
IV_THR_BASE = 0.42
BURST_IV_MULT = 0.88
CALM_IV_MULT = 1.06
Z_WINDOW = 50
