"""
Round 3 velvet spike playbook v1: same logic as v0; parameter sweep cell — BURST_OPEN_MULT=0.65
(v0 uses 0.72). See results.json for backtest comparison.
"""
