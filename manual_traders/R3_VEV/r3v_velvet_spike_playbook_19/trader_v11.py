"""
Velvet spike playbook v11: more aggressive burst open threshold (parent v7).

- Same as v7: ATM 0.24/0.10 burst/calm, burst lot cap 80, low-z flattening.
- Grid: BURST_OPEN_MULT=0.82 (v7=0.88) to quote tighter IV scalps in burst.
"""
