...
"""
Family 12 variation A (ungated): smile cubic spline in log-moneyness for fair IV,
then MM around theo with burst-vs-calm risk knobs. No strike-liquidity gating.
"""
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for k, m in mid_by_k.items():
            ...
            # quote around theo with edge; take if book crosses fair+edge.
