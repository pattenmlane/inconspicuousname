...
"""
Family 12 v15: ungated spline log-k with delta/beta-scaled execution.

Analysis-driven tweak: voucher response to underlying is contemporaneous (best lag 0)
and beta falls monotonically with strike moneyness. Use this by scaling edge/lot by
model delta and a strike-beta proxy; avoid overtrading low-response wings.
"""
...
EMA_KEY = "fam12_spline_delta_beta_scaled"
