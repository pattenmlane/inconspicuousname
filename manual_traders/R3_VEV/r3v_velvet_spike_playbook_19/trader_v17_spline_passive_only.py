...
"""
Family 12 v17: v15 with passive-only quoting (no market-taking).

Analysis-driven tweak: v15 take-gap replay showed negative one-step proxy even at gap=0
for both buy/sell takes, so v17 disables crossing the spread and keeps only passive quotes.
"""
...
EMA_KEY = "fam12_spline_passive_only"
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for k, m in mid_by_k.items():
            ...
            # v17 passive-only: no market-taking (gap analysis showed adverse short-horizon expectancy).
            # passive quotes
            if buy_cap > 0:
