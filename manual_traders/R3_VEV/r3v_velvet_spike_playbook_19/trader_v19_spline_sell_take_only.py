"""
Family 12 v19: v15 spline with asymmetric taking (sell-take only by default).

Analysis on v15 submission takes (one-step proxy) showed buy-side crossing was
materially worse than sell-side crossing. Keep the same smile/MM core and
response scaling, but disable buy-taking while preserving sell-taking + passive
...
EMA_KEY = "fam12_spline_sell_take_only_v19"
...
# Asymmetric taking controls from v15 take analysis.
ENABLE_BUY_TAKE = False
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for k, m in mid_by_k.items():
            ...
            if ENABLE_BUY_TAKE and ba <= bid_px and buy_cap > 0:
