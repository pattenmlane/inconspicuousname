"""
Velvet spike playbook v2: same burst/calm IV+open scaling as v0, but only quote strikes in an
ATM-relative band (wider on burst = cluster focus; tighter in calm = pull wings / avoid deep
wings where global smile extrapolates badly).
"""
...
CALM_OPEN_MULT = 1.12
WARMUP_DIV100 = 10
# |K/S - 1| max; burst widens cluster toward wings
ATM_REL_BURST = 0.24
ATM_REL_CALM = 0.10
