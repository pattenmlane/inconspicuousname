"""
Velvet spike playbook v3: grid on v2 — tighter calm regime (smaller THR_OPEN in calm, narrower
ATM band when not bursting) to reduce wing noise while keeping burst widening.
"""
