"""
Velvet spike playbook v5: conservative burst participation + calm mean-revert smile MM.

- Burst: still widens cluster, but weaker aggression (higher THR_OPEN, higher IV gate).
- Calm: keep active core smile market-making.
- Very calm fallback (low z): flatten inventory by quoting only in mean-reverting direction.
"""
