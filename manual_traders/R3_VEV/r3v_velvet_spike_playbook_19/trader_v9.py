"""
Velvet spike playbook v9: v5 + smaller burst per-order size cap (grid sweep parent v7).

- Same as v7 but BURST_MAX_LOT=60 (v7=80) to test whether a tighter cap improves day-0
  burst fills without starving days 1-2. Same widen-on-burst / pull-wings thesis.
"""
