"""
r3v_volume_weighted_residual_05 v10 — Parent: v8 (best PnL in series).

Same thesis: fade IV minus volume-WLS smile residual; EMA on raw resid; 5100–5500 strip.

v10 grid (vs v8, small sweep): α=0.11, RESID_ENTER=0.014, RESID_EXIT=0.0042,
min top book sum 26. Keeps linear WLS weights 1+volume (v9's vega-weighted WLS was worse).
"""
