"""
r3v_volume_weighted_residual_05 v2 — Iteration after v0/v1 backtests.

v0: hydrogel carried PnL while deep strikes lost; v1: full delta hedge hurt badly.

v2 changes (grid vs v0):
- Hydrogel: small passive quotes only when spread >= 14 (less dominant than v0).
- Skip strikes with top-of-book spread > 8 (microstructure filter from tape).
- RESID_ENTER 0.015, RESID_EXIT 0.005, MAX_Q 12.

Timing / csv_day anchors: same as trader_v0.py.
"""
