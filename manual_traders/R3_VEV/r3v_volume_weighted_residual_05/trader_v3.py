"""
r3v_volume_weighted_residual_05 v3 — Keep same thesis, tighter product selection.

Concept unchanged: fade IV minus volume-weighted WLS smile residual.
Iteration changes (from v2):
- Trade only liquid middle strikes for the residual leg: VEV_5000..VEV_5500.
- Keep spread filter and vega-scaled sizing.
- Keep conservative HYDROGEL_PACK passive quoting.
"""
