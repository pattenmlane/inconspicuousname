"""
r3v_volume_weighted_residual_05 v4 — Keep same thesis, broader liquid strip.

Concept unchanged: fade IV minus volume-weighted WLS smile residual.
Iteration changes (from v2):
- Trade a broader liquid strip for the residual leg: VEV_5000..VEV_6000.
...
TRADE_VOU = [f"VEV_{k}" for k in (5000, 5100, 5200, 5300, 5400, 5500, 6000)]
