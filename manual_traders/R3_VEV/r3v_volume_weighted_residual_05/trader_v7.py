"""
r3v_volume_weighted_residual_05 v7 — Parent: v3 (self-contained WLS on trade strip only).

Thesis: fade IV minus volume-weighted WLS smile residual.

v7: v5/v6 full-chain refits hurt PnL; v7 keeps v3's **closed** 5-strike system but
  drops VEV_5000 (largest systematic drag in 5000–5500 backtests) — fit and
  trade on VEV_5100..VEV_5500 only. All other parameters match v3.
"""
