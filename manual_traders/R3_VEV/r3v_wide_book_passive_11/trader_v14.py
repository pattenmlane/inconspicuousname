"""v14: v13 + 1-tick shallower passive on extract shock (spread compression after large moves in tape).
...
class Trader:
    def run(self, state: TradingState):
        ...
        for sym in TARGET_VEV:
            ...
            if shock:
                center_shift = int(round(extract_move * VEV_CENTER_SHIFT_BETA))
