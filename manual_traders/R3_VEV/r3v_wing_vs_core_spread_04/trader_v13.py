"""
v13: Parent v2 with lower extract hedge and smaller clips to reduce hedge churn
under worse fills (grid: HEDGE_FRAC 0.62, MAX_LEG 10, slightly relaxed RICH/CHEAP).
"""
