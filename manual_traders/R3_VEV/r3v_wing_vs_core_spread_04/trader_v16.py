"""
v16: Parent v15 — tighter RICH/CHEAP (tape: max |wing resid| often >0.014; see wing_resid_thresholds_v16.json).
HEDGE_FRAC 0.28 unchanged. Grid: RICH 0.014, CHEAP -0.015, MAX_LEG 10.
"""
