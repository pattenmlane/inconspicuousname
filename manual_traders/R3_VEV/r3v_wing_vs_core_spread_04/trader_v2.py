"""
v2: Smile-curvature fade (parent v0 path). Grid iteration: stricter cheap-wing
filter (time value vs mid) to avoid deep-ITM IV artifacts; slightly higher hedge.
"""
