"""
v27: family10 nearby-distinct variant (anti-duplicate).
Regime-dependent calibration universe:
- normal regime: all strikes in WLS quadratic fit
- stressed regime: core + nearest wings {5000,5100,5200,5300,5400} in WLS fit (fallback all if insufficient points)
...
STRESS_EXTRACT_SPREAD = 6
STRESS_EXTRACT_LIQ = 110
CORE_KS = {5000, 5100, 5200, 5300, 5400}
WLS_MAX_W = 60.0
