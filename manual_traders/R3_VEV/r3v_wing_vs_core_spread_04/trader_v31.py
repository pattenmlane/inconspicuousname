"""
v31: Parent v30 with live BS-delta leg caps (Greek risk sizing).
High-|delta| wings clip smaller; very low |delta| stay near MAX_LEG.
"""
...
def _leg_cap_from_delta(dlt: float) -> int:
    # Trim only high-|delta| legs (near-ITM); do not upsize low-delta OTM (would add VEV_6000 flow).
