"""
v36: v30 + no cheap-wing *long* on VEV_6000/VEV_6500.

Tape OLS shows ~zero extract beta on those strikes; fill summaries attribute -450 of
branch PnL to VEV_6000 longs. We still allow rich shorting (resid>RICH) on the full
WING_KS set and use all strikes in the smile fit; only inversion (lift ask) is
disabled for 6000/6500. Shock cheap shift (v30) unchanged for other wings.
"""
