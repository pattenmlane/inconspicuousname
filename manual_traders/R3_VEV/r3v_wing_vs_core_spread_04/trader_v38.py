"""
v38: Parent v37 + restore VEV_6500 to WING_KS (still exclude 6000 only).

v30 submission parse had zero VEV_6500 rows vs 75 VEV_6000 buys; re-adding 6500
tests whether upper far wing adds edge without the 6000 worse-fill drag.
Smile fit unchanged (all strikes with valid IV).
"""
...
WING_KS = {4000, 4500, 5400, 5500, 6500}
