"""
v39: v37 + lighter extract hedge (HEDGE_FRAC 0.24).

Tape: contemporaneous mid changes give OLS beta d(VEV_5400)/d(extract) ~0.13 with
corr ~0.57 (vev5400_mid_beta_vs_extract_v39.json) — dominant wing co-moves with
underlying; prior branch work showed extract hedge drag under worse fills when
hedge fraction was high. v37 path is VEV_5400-centric; nudge hedge down one step
from 0.28 toward the v15-era lesson without returning to pre-v30 shock logic.
"""
