"""
v5: Smile-curvature fade with focused tradable wings (parameter sweep vs v4).
Changes: slightly stricter rich threshold, stronger delta hedge, and no cheap-wing
long entries; keep short-cover when residual normalizes.
"""
