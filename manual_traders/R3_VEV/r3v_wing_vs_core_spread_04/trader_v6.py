"""
v6: Smile-curvature fade (active variant from v2).
Keep rich-wing shorts broad, but disallow cheap-wing longs on lower deep-ITM wings
(4000/4500) that were consistently lossy in prior runs.
"""
