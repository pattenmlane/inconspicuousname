"""
v7: Parent v2; grid A — only VEV_5400/5500 for entries; sell rich residuals;
short-cover when resid < EXIT_THR; no cheap-wing longs (hedge 0.65 to cut extract bleed).
"""
...
# Upper wings only: tape analysis (iv_greek_strike_tradeability) showed 5400/5500
# had material vega; lower wings dominated hedge drag and IV noise.
WING_KS = {5400, 5500}
    ...
    def run(self, state: TradingState):
        ...
        for v, K, mid, iv, delta, tv_frac in strikes_data:
            ...
            if resid > RICH_THR and pos > -lim + 1:
                ...
                # Exit shorts when fitted smile catches up.
                qty = min(MAX_LEG, -pos)
            if qty == 0:
                continue
