"""
Round 4 trader v16 — v15 variant: **no clip trim** when Mark49 overlap and Sonic **tight** (0).

Rationale: v15 uses -1 on tight overlap; if joint gate already implies good hedging, extra reduction
may waste edge. Loose overlap still -3. Floor 4, days 1-2, else v8 stack.
"""
