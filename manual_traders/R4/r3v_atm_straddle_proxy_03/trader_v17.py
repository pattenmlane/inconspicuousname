"""
Round 4 trader v17 — v16 variant: **-4** trim on M49 overlap when Sonic **loose** (0 when tight).

Tests slightly stronger de-risking in the worst microstructure regime; days 1-2, floor 4.
"""
