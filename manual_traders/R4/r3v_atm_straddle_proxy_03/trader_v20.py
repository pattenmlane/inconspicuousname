"""
Round 4 trader v20 — **hybrid** of v15 and v17: M49 overlap trim **-1** when Sonic **tight**, **-4** when **loose** (v15 had -1/-3, v17 had 0/-4).

Tests whether a small safety trim on tight co-ticks recovers all-match PnL without giving up v17's loose-regime win.
"""
