"""
Round 4 trader v21 — v18 with **-6** trim on M49 overlap when Sonic **loose** (0 when tight).

Grid step beyond v18 (-5): test whether further size reduction still helps under worse fills or hits floor-4 too often.
"""
