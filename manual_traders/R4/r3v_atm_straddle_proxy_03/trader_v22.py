"""
Round 4 trader v22 — v21 with **-7** trim on M49 overlap when Sonic **loose** (0 when tight).

Sweep continuation past v21 (-6); many overlap ticks already floor at clip 4 after -6, so -7 may plateau or hurt.
"""
