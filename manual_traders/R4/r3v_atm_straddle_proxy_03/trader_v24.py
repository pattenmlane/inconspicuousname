"""
Round 4 trader v24 — v21 with **tight trim -1** (loose still -6).

v20 used tight -1 / loose -4 and tied v17 on worse; v21 uses 0/-6 as champion. Hybrid tests whether
the v15-style small trim on tight overlap helps when loose path is already at v21 strength.
"""
