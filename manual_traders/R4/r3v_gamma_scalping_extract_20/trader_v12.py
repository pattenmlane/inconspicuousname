"""
Round 4 — **v8** with **OPTION_CLIP = 6** (smaller surface size days 1–2).

Same as **trader_v8**: no **VEV_5200/5300** MM on tape day 3; gate + Mark 67
extract unchanged. Sweeps surface inventory risk on days 1–2 vs **v8** clip 10.
"""
