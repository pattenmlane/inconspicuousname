"""
Round 4 — **v8** with **MM_EDGE = 0** (quote at best bid / best ask when spread allows).

Tests whether stepping **inside** the BBO on days 1–2 surface improves `worse`
fills vs **v8** (MM_EDGE=1).
"""
