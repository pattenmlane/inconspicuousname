"""
Round 4 — **v19** with **Mark 67 extract follow NOT gated on Sonic joint tight**.

**Surface MM** still requires the joint gate (5200+5300 spread≤2) and still skips
tape day 3 (**v8** calendar). **Mark 67** aggressive-extract lift runs **whenever**
the tape shows it (same price≥ask rule, **CLIP_EX=20**, **MAX_EX_POS=120**),
independent of whether 5200/5300 are tight this tick.

Tests whether Phase 1/2 **Mark 67** signal has edge **outside** the tight voucher
regime (counterparty thesis decoupled from Sonic surface gate for extract only).
"""
