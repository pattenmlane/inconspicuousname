"""
Round 4 — v6 + throttled wide exits (v8).

Parent v6: passive bid in tight, aggressive ask exit in wide.
v8: same passive **entry**; only attempt wide exit every **EXIT_EVERY** ticks
(ts//100) to reduce adverse-selection churn from posting sells every wide tick.
"""
