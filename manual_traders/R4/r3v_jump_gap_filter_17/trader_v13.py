"""
Round 4 iteration 13 — Mark22 aggressive-buy prints: **bid +2** clip vs v11’s +1 (same conditions).

Same as **v11**: `mq_bid = mq_base + 2` on any precomputed print tick, `mq_ask = mq_base`
(off-joint: 5+2=7 bid / 5 ask; joint-on: 18 bid / 16 ask). Fair unchanged.
"""
