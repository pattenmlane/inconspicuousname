"""
Round 4 Phase 3 — **Sonic joint gate** on top of Phase 2 Mark 67 flow.

Same precomputed triggers as `trader_v23.py` (`outputs/r4_v23_signals.json`: Mark 67
aggressive buy on VELVETFRUIT_EXTRACT, merged backtest timeline).

**Change vs v23:** only lift **VEV_5300** at the ask when **both** **VEV_5200** and
**VEV_5300** top-of-book spreads are **≤ 2** ticks (Sonic recipe from
`vouchers_final_strategy`). Outside that regime, do not open new longs; flatten
held V5300 to bid when the signal window is off (same hygiene as v23).
