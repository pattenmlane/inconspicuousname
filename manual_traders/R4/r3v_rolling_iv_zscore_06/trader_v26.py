"""
Round 4 iteration — **Mark 67** extract flow with **tape-time Sonic pre-filter**.

Precomputed triggers: `outputs/r4_v26_signals.json` from `r4_phase5_mark67_micro_joint.py`.
Only timestamps where **VEV_5200** and **VEV_5300** were jointly tight (spread<=2)
**at the Mark 67 aggressive extract print** (27 of 164 on R4 days 1–3). The
microprice>mid clause is vacuous on this slice (see refine note in JSON / txt).
