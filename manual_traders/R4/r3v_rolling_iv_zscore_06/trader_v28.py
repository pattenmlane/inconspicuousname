"""
Round 4 — **v26 with shorter post-trigger window** (25_000 merged-ts units vs 50_000).

Same triggers (`r4_v26_signals.json`) and same entry/exit logic as `trader_v26.py`
except **window_ts is overridden to 25_000** to align with tape evidence that joint
tight often breaks within ~100 ticks of the print (`r4_p6_joint_tight_persistence...`).
...
def _load_signals() -> tuple[list[int], int, dict[int, int]]:
    ...
    _SIG_PACK = (tr, _WINDOW_OVERRIDE, cum)
    return _SIG_PACK
