"""
Round 4 — **v26 with smaller clip** (Q=4 vs 6).

Same triggers and window as `trader_v26.py` (`r4_v26_signals.json`, window 50_000).
Smaller lift size to reduce adverse selection on touch.
