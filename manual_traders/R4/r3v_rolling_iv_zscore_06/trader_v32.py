"""
Round 4 — **v26 with capped V5300 inventory** during signal windows.

Same triggers as `trader_v26.py` (`r4_v26_signals.json`, W=50_000). Tape analysis
(`r4_p8_v26_window_overlap.txt`) shows up to **3** trigger windows can overlap on
the merged timeline — v26 can stack long exposure. This variant **stops lifting**
once **VEV_5300** position reaches **MAX_Q=18** (3 clips of 6); still flattens to
bid when the window ends.
