"""
Round 4 — **v37 with tighter EOD window** (PAD=500 vs 5000).

Same as `trader_v37.py` but flatten only in the last **500** local timestamp units
before `999_900`, reducing premature exits on day 1 while still clearing most
overnight carry before tape day roll.
