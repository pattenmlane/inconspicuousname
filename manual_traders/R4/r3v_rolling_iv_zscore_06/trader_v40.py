"""
Round 4 — EOD bracket sweep around v38 (**PAD=500**): this file uses **PAD=200**.

Result on R4 days 1–3: total **+3,231** (matches fixed v26); v38's +22 came from
the **500**-wide window, not tighter. See `trader_v41` (300) / `trader_v42` (750).
