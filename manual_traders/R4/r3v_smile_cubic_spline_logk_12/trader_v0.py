"""
Round 4 trader_v0: joint-gate + arith-mid microstructure (from R3 trader_v29), plus **HYDROGEL_PACK**
passive quotes for full Round 4 product scope. Counterparty-conditioned logic is **Phase 3+**;
this baseline is for backtest PnL anchoring.

TTE (Round 4 example): TTE_days = 5 - tape_day (days 1,2,3 → 4,3,2). Reserved for future BS.
"""
