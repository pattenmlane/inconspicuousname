"""
Round 4 trader_v1 (Phase 3): **Sonic-gated extract** — only place **VELVETFRUIT_EXTRACT** passive quotes
when **VEV_5200** and **VEV_5300** BBO spreads are both <= 2 (same tick as R3 `analyze_vev_5200_5300_tight_gate_r3.py`).
VEV + HYDRO unchanged from v0 (tape analysis: M01→M22 flow is on vouchers, not extract).

TTE note reserved per round4work/round4description.txt example.
"""
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        # else: no extract quotes — gate says mid dynamics unreliable off tight surface
