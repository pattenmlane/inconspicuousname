"""
Round 4 trader_v14: **trader_v13** with **Phase 2 burst-window** extract ask skip **off on tape session 3**.

**v13** adds omit-extract-asks when offline **M01→M22** burst ±500 and gate-off; worse total
**+795** vs v12 but day3 total **−524** vs v12 (extract worse on d3). **v14** disables only
the **burst** leg on session **3** (same index as `M67_M22_OFF_SESSION`); M67 legs + hydro
unchanged from v13.
"""
