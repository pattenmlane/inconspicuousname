"""
Round 4 trader_v15: **trader_v14** + **trader_v2**-style **VEV_5300** nudge in the same
offline **M01→M22** burst ±500 window (wider take/make edges, 88% MM/take sizes).

Phase 2 table: **VEV_5300** mean mark_20 **−0.13** in-window (n=162) — conservative on the
wing when basket choreography is active. **Extract** burst ask-suppression unchanged from v14.
"""
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        for sym in VEV_SYMS:
            ...
            mm_v, tk_v = mm, tk
            if burst_near and sym == "VEV_5300":
