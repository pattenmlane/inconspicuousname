"""
Round 4 iteration 12 — duplicate of trader_v2 (Sonic joint gate only, passive extract buy).

Re-run baseline for auditable iteration bookkeeping after Phase-1 extension analyses.
"""
