"""
Round 4 iteration 16 — Joint gate + flat boost Q=8 when |extract pos|<=30 else Q=4.

Ablation vs v5 (Q=6 if |pos|<=15) and v2 (fixed Q=4): wider flat band, larger clip.
"""
