"""
Round 4 iteration 17 — Joint gate + flat boost Q=8 when |extract pos|<=20 else Q=4.

Tighter flat band than v16 (|pos|<=30) to test day-3 sensitivity from v2 vs v16 split.
"""
