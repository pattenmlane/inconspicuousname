"""
Round 4 Phase 3 — Sonic joint gate only (no burst list, no counterparty filter).

When VEV_5200 and VEV_5300 L1 spreads both <=2, passive buy VELVETFRUIT_EXTRACT one tick
inside BBO (small size). Day inferred from extract mid at ts=0 (same anchors as v1).

Compares to trader_v1 (burst + tight) to isolate gate-only PnL vs burst-conditioned.
"""
