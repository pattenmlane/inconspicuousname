"""
Round 4 post-Phase3 — Sonic joint gate + long cap (no sells).

Same passive buy as v2 when joint tight, but skip new buys when extract position >= MAX_LONG
to limit pyramiding without passive asks (v3 showed asks hurt).
"""
