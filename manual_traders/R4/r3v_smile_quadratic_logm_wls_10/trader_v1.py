"""
Round 4 trader_v1 — executable proxy for Phase-2 joint-gate finding (Sonic):
when VEV_5200 and VEV_5300 both have top-of-book spread <= 2, one-tick MM on
VELVETFRUIT_EXTRACT + VEV_5200 + VEV_5300 only. No counterparty fields in
TradingState during run (backtester does not pre-fill market_trades); offline
tape analysis uses buyer/seller (see r4_phase2_*.csv).

HYDROGEL_PACK not traded (focus extract + gate legs).
"""
