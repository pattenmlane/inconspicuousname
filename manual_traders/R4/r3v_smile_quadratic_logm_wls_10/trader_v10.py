"""
Round 4 trader_v10 — same as v5 (joint gate + full VEV + hydro) but larger
VELVETFRUIT_EXTRACT per-side clip (22 vs 18 on core strikes) to test extract
fill saturation on top of v5 stack.
"""
