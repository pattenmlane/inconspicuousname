"""
Round 4 trader_v12 — v5 (joint gate + full VEV + hydro) with relaxed core spread
threshold: require VEV_5200 and VEV_5300 both ≤ 3 (vs Sonic ≤ 2 in v5).

Ablation: test whether a looser “surface tight enough” filter increases quote time / PnL
without explicit counterparty state (backtester has no market_trades in-state).
"""
