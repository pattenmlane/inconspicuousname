"""
Round 4 trader_v2 — Phase 3 follow-up: same Sonic joint gate as v1, but one-tick MM
on the full VEV surface (all strikes) plus extract when 5200 and 5300 are both
tight (spread <= 2). Motivation: Phase 3 spread–spread panel shows strong
co-movement of book widths across strikes on the inner-join timestamp grid.

HYDROGEL_PACK not traded. Counterparty IDs remain unavailable in TradingState.run
(same backtester limitation as v1).
"""
