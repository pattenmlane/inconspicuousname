"""
Round 4 trader_v5 — v2 + HYDROGEL_PACK: Sonic joint gate then one-tick MM on
VELVETFRUIT_EXTRACT, all VEV strikes, and HYDROGEL_PACK (smaller clip on hydro).

Ablation for cross-product MM when voucher surface is tight (Phase 1 hydro
duopoly 14↔38 is high-count but separate from VEV basket flow).
"""
