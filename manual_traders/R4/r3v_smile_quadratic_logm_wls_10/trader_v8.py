"""
Round 4 trader_v8 — same as v5 (joint gate + extract + all VEVs + hydro) but
wing VEV per-side clip 20 instead of 10 (core 5200/5300 and hydro unchanged).

Ablation for wing fill saturation vs v5.
"""
