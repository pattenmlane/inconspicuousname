"""
Round 4 trader_v9 — v2 plus HYDROGEL_PACK: joint gate then one-tick MM on extract,
all VEV strikes, and hydro with per-side clip **6** (v5 uses 8). Ablation for
whether hydro clip binds on top of full wing MM.
"""
