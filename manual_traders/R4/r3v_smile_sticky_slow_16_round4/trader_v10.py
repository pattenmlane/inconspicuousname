"""
Round 4 — **v9 + wider tight ask** (grid search on winning skew).

- **v9** (best so far): Sonic tight extract **mid\u22121** / **mid+2**, size 12.
- **v10**: same bid; ask at **mid+3** \u2014 tests whether v9\u2019s +2 ask was still too tight for **worse** sell fills.
- Else identical to v9 (hydro/VEVs, gate, Mark38/67).
"""
