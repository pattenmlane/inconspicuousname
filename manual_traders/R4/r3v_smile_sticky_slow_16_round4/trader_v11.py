"""
Round 4 — **v9 family: symmetric wide tight extract** (both sides mid\u00b12).

- **v9**: tight extract **mid\u22121** / **mid+2** (asymmetric).
- **v11**: tight extract **mid\u22122** / **mid+2** \u2014 symmetric half-spread 2 on bid and ask in the Sonic-tight window
  (vs non-tight mid\u00b12 for all symbols). Tests whether v9\u2019s win required **asymmetric** ask only vs symmetric widening.
- Same hydro/VEVs/gate/Mark38/67 and tight size 12 as v9.
"""
