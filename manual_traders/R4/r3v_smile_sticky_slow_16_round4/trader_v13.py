"""
Round 4 — **v10 + wider tight ask (+4)** (grid continuation).

- **v10**: Sonic tight extract **mid\u22121** / **mid+3**, size 12 \u2014 best **worse** total so far.
- **v13**: same bid; ask **mid+4** \u2014 tests diminishing returns vs +3 (may hurt day3 lift further).
"""
