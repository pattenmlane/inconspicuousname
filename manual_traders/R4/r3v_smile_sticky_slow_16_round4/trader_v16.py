"""
Round 4 — **v12 + tape day2 ask +2** (ablation on day2 where most v12 PnL lives).

- **v12**: tight ask **+3** tape days **1\u20132**, **+2** day **3**.
- **v16**: tight ask **+3** day **1**, **+2** day **2**, **+2** day **3** \u2014 tests whether day2 still wants the **+3** passive ask (v15 showed day1 wants +3).
"""
