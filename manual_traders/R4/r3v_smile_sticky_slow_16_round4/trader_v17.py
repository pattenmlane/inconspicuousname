"""
Round 4 — **v12 + Mark 67 lift widen ask** (counterparty-conditioned skew).

- **v12** schedule for tight-regime extract ask half: **+3** days **1\u20132**, **+2** day **3**.
- **v17**: when Sonic **tight** and **Mark 67** **aggressive buy** on extract this tick (`market_trades`), add **+1**
  to the tight ask half (cap **4**) before rounding \u2014 slightly more passive **ask** when tape shows lift at touch,
  complementing the existing **+2 bid size** boost (still applied).
"""
