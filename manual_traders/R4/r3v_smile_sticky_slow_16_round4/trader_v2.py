"""
Round 4 — post-Phase-3 experiment: **Sonic gate on extract + hydrogel** (VEVs unchanged).

- **Tape analysis** (`analyze_r4_hydro_fwd_vs_sonic_gate.py`): HYDROGEL K=20 forward **mid** is **not**
  significantly higher when gate tight vs loose (pooled Welch p\u22480.78; day signs flip). So gating hydrogel
  is **not** tape-supported like extract; this trader tests **PnL impact** of skipping hydrogel MM outside tight.
- **Tight:** quote **VELVETFRUIT_EXTRACT** and **HYDROGEL_PACK** mid\u00b12; **VEV_*** always.
- Same **market_trades** hooks as v1 on extract only.
"""
