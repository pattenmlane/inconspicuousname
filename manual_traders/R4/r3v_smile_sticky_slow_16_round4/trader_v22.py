"""
Round 4 — **v19 + stronger Mark 67 bid-size boost** on extract.

- **v19**: `BOOST_BID = 2` added to extract **bid** quantity when **M67 aggressive buy** (tight path uses base 12).
- **v22**: `BOOST_BID = 5` (was 2) \u2014 tests whether prior size tweaks were no-ops because **+2** was too small vs
  fill granularity under `--match-trades worse`. All prices / M67 bid-widen / ask schedule identical to **v19**.
"""
