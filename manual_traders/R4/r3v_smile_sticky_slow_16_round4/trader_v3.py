"""
Round 4 — v2 + **gate the hedging legs** (VEV_5200 / VEV_5300).

- Same as **trader_v2** (extract + hydro only when Sonic tight; VEVs mid\u00b12; Mark38/Mark67 hooks).
- **Tape** (`r4_pair_extract_fwd20_vs_gate.json`): e.g. Mark14\u2192Mark55 **sell_agg** extract fwd20 mean **+0.18**
  when gate **tight** vs **-0.39** when **wide** (n 84 vs 232). Hypothesis: when surface is wide, **do not**
  quote the two gate symbols as passive liquidity (reduce noise / adverse flow on the hedge surface).
"""
