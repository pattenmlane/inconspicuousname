"""
Round 4 — **v5 with milder tight-extract size** (ablation on BASE_SZ_U_TIGHT).

- Same as **trader_v5** (extract mid\u00b11 when Sonic tight; hydro/VEVs v3-style; Mark 38 / Mark 67).
- Tight-regime extract size **9** instead of **12** \u2014 tests whether v5\u2019s day2 extract dip vs v3 is mostly **size**
  on the tighter grid.
"""
