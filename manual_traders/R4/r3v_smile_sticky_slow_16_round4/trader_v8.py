"""
Round 4 — **v5 + asymmetric tight extract** (skew instead of symmetric mid±1).

- **v5** when Sonic tight: extract **mid − 1** / **mid + 1** (symmetric), size 12.
- **v8** when Sonic tight: **bid** at **mid − 2** (same half as non-tight / more passive buying), **ask** at **mid + 1**
  (keep tight offer to capture lift). Size 12 unchanged. Hypothesis: Phase-1 sell-side / adverse-selection stories
  hurt the **bid** more than the **ask**; widening bid only may beat symmetric ±1.
- Hydrogel, VEVs, gate skip, Mark 38 / Mark 67: same as v5.
"""
