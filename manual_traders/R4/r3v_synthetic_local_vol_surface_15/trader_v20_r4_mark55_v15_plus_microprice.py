"""
v15 scaled-clip (ROLL 0.20–0.40, SAT 0.72) + Phase-2 **microprice > mid + 0.35** on extract
(same filter as v5) before firing Mark55 aggr-buy follow.
"""
