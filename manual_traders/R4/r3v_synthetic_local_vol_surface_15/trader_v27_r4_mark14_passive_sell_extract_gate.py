"""
Round 4 — Phase-1 slice **not yet live-tested**: on EXTRACT, **Mark 14** is the **seller** on
**aggressive-buy** prints (someone lifts ask; Mark 14 passive at ask).

Tape (`r4_p1_participant_fwd_mid_k20.csv`): seller Mark14 × aggr_buy × K=20, n=331,
mean_fwd20 ~0.048 (small positive vs 0).

Live: same execution as v4 (ba+1, CLIP=12) but fire when **seller** is Mark 14 and trade
price >= ask, **only** under Sonic joint gate (TH=2 on VEV_5200/5300).
"""
