"""
Round 4 Phase 3 — **Sonic joint gate** + Phase-1 Mark 67 counterparty signal.

Trade only when **VEV_5200** and **VEV_5300** both have top spread (ask1−bid1) ≤ 2,
same convention as round3work/vouchers_final_strategy (inner join on timestamp in analysis).

If gate on **and** tape shows Mark 67 aggressive buy on VELVETFRUIT_EXTRACT (price ≥ ask1),
buy clip at **ba+1** (worse-fill crossing).

See outputs_r4_phase3/ for population-level gate vs Phase-1 interaction stats.
"""
