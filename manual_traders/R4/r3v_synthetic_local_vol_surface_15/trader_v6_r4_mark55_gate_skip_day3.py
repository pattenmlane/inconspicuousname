"""
Round 4 — Same as **trader_v4** (Mark 55 aggr-buy extract under Sonic gate) but **no trades on
historical day 3** (`state.backtest_day == 3`) to cap tail risk where v4 lost ~1.7k.

Days 1–2 unchanged vs v4 logic.
"""
