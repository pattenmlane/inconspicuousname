"""
Round 4 — v10 with larger loose-path extract clip (SIZE_U_SOFT=14 vs 8).

Same Mark55 aggressive skip on loose soft U as v10; tests whether harness is size-saturated
only on tight path (v5–v7) or also on filtered loose U.
"""
