"""
Round 4 — v11 with **stricter** Sonic joint gate: both VEV_5200 and VEV_5300 BBO spreads <= 1
(v11/v5 use <= 2).

Hypothesis: Phase-3 extract mid is higher under tight; stricter joint may improve quote quality
if wider (spr=2) joint cells are noisier. Loose-path Mark55 skip and sizes unchanged from v11.
"""
