"""
Round 4 — v11 with **looser** Sonic joint gate: VEV_5200 and VEV_5300 BBO spreads both <= 3
(v11 uses <= 2; canonical Sonic in STRATEGY is 2-tick wide books).

Loose path and Mark55 skip identical to v11 (SIZE_U_SOFT=14).
Ablation: does marginal widening (include spr=3 joint cells) add harness PnL or dilute?
"""
