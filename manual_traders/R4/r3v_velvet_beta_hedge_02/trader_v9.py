"""
Round 4 — v8 ablation: when joint gate is **off**, quote **VELVETFRUIT_EXTRACT** only (soft size).

Same as v8 when **tight** (full v5 surface + hydro). Rationale: v8 loose path added inner VEVs;
day-2 extract PnL collapsed vs v5 — isolate whether **inner VEV soft MM** vs **extract soft MM**
...
class Trader:
    def run(self, state: TradingState):
        ...
        if joint:
            ...
            td = {"joint": False, "mode": "u_soft_only"}
