"""Round 4 trader v11 — v10 with **shorter Tier-A aggression cooldown** (15 vs 25).

Same as `trader_r4_v10` otherwise (buy at ask qty 3, min buy room 8).

See `results.json` iteration 13.
"""
