"""Round 4 trader v7 — **sell-trim-only** Tier-A (ablation vs v4).

Tier-A: Sonic tight + Mark67→Mark22 on VELVETFRUIT_EXTRACT tape.

**vs v1:** on signal only — reduce **sell** clip by 2 (floor 2); buy clip unchanged; **prices unchanged** (v1 bid/ask).
**vs v4:** no bid bb+2, no buy bump, no ask lift (isolate **sell trim** effect).
"""
