"""Round 4 trader v9 — v8 with **stricter inventory gate** on Tier-A aggression.

Same as `trader_r4_v8`: Sonic tight + Mark67→Mark22 on extract → small buy at
best ask before passive quotes, with buy-room reservation and cooldown.

Change vs v8: only fire the aggressive leg when **long extract position <= 100**
(v8 used 160). Hypothesis: paying the spread adds less value when already
inventory-heavy; offline Tier-A is a short-horizon drift signal.

See `results.json` iteration 11 (v9 row).
"""
