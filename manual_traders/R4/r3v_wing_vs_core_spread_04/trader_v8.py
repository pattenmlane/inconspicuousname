"""
Round 4 v8 — **Mark 67 → Mark 49** on VELVETFRUIT_EXTRACT when **joint Sonic gate was
tight at print** (12 events from phase3 tape merge).

Phase 3 table (mark67_to_mark49_extract_fwd_k20_by_joint_tight.csv): mean K=20 fwd extract
is **+1.08** when tight-at-print (n=12) vs **+1.72** when wide (n=77) — still positive
but weaker; this sim tests whether the **tight subsample** alone remains taker-profitable
under the same lag + act-gate mechanics as v1.

Signals: outputs/phase3/signals_mark67_to_mark49_extract_joint_tight_at_print.json
"""
