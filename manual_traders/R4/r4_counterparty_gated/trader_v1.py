"""
Round 4 — Phase 2: extract spread regime (BBO <= 2 predicts higher fwd mid on tape;
see r4_phase2_extract_fwd20_by_spread_tight.csv) + optional lift when precomputed
Mark 67 aggressive-buy-on-extract key matches (signals_mark67_aggr_extract_buy.json).
Products: HYDROGEL_PACK, VELVETFRUIT_EXTRACT, VEV_* per round4description.
"""
