"""
Round 4 — trader_v11 plus inventory guard: skip Mark67 joint-gated aggressive extract take
when extract long position already exceeds M67_TAKE_MAX_LONG (avoid stacking buys).
"""
...
EXTRACT_INV_MAX = 3
M67_AGGR_BUY_Q = 22
# Skip M67 take if already this long on extract (inventory-aware adverse-selection guard).
M67_TAKE_MAX_LONG = 85
