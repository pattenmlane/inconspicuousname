"""
Round 4 Phase 3 — Sonic joint gate: VEV_5200 and VEV_5300 BBO spreads both <= 2 (same tick).

When joint tight: more aggressive extract + VEV MM (tape: pooled extract fwd20 higher under gate;
Mark67→Mark22 extract mean slightly higher when tight in r4_phase3_triplet).

Else if only extract BBO tight (Phase 2): moderate (trader_v1-style).
Else: defensive wide quotes.
"""
