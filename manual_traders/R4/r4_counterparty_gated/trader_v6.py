"""
Round 4 — v1 plus live counterparty read from state.market_trades (populated by backtester
before each run): under Sonic joint tight, if this tick's tape includes Mark01→Mark22 on
VEV_5300, skip the bid on 5300 (fade supply). Mark67 JSON lift unchanged from v1.
"""
