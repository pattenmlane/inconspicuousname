"""Round 4: v7 with **smaller** clips and cap (risk / inventory sensitivity).

Same gate+burst, join-buy, ask-1-style exit, MIN_HOLD. LOT=2, MAX_POS=24 vs v7 LOT=3, MAX_POS=36.
"""
