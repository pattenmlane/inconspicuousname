"""Round 4: v11 scale-up — max 90 contracts on VEV_5300, LOT=6 (still <=300/strike).

Same gate+burst, join-buy, ask-1 exit, MIN_HOLD as v7/v11. Tests whether v11
linear scaling extends toward position cap.
"""
