"""
Round 4 — **v11 + larger tight-gate clip on Sonic legs (5200/5300)**.

Hypothesis: those two names define the joint gate; they also carry large terminal PnL in
v11. Bump passive clip from **6** to **CLIP_V_GATE** for **VEV_5200** and **VEV_5300** only
when **joint tight**; **VEV_5100,5400,5500** unchanged. Otherwise identical to v11.
"""
