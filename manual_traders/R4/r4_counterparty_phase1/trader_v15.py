"""Round 4: v12 + **entry** filter on Mark22 sell qty on VEV_5300 (no early exit).

Unlike v14: same **exit** as v12 (sell only when gate+burst **off**, after MIN_HOLD).
Only skip **new** longs when m22_sell_qty_5300 >= M22_HIGH (default 4) at a burst tick.

Tests whether v14’s sim damage was from **early exit** rather than the entry filter.
"""
...
class Trader:
    def run(self, state: TradingState):
        ...
        can_buy = active and m22q < M22_HIGH
        if active:
