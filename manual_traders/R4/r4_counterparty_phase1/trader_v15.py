"""
Round 4 — **v11 + larger tight-gate clip on non-gate surface strikes**.

`trader_v14` raised clip on **VEV_5200/5300** (Sonic legs) 6->8 with **null** terminal PnL vs v11.
`trader_v15` keeps gate legs at **CLIP_V=6** and uses **CLIP_V_WING=8** for **VEV_5100, 5400, 5500**
when joint tight (5100/5500 are often wings vs 5200/5300 in the community framing).
"""
...
def _clip_vev_tight(product: str) -> int:
    if product in GATE_LEGS:
        return CLIP_V
    return CLIP_V_WING
