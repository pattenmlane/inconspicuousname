"""
Round 4 — **v11 with looser Sonic joint gate (spread <= 3)**.

v11 uses **SPREAD_TH=2** on **VEV_5200** and **VEV_5300**. Tape slice for aggressive VEV buys
under strict tight has almost no Mark49 and tiny Mark22 n (`r4_v17_aggrbuy_tight_gate_summary.txt`).
This variant tests whether a **moderate** surface (both legs <= **3** ticks) improves `worse` PnL
while keeping the same counterparty skips and clips as v11.
"""
