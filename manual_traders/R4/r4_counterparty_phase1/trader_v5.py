"""Round 4: gate + M01→M22 burst — **improved passive** long VEV_5300 (vs v4 strict bid).

Tape analysis (r4_burst_tight_5300_trade_vs_book.json): at tight+burst timestamps,
161 VEV_5300 prints sit at **bid** in 159 cases — join **min(bid+1, ask)** when spread>=2
else bid, to get **worse** matcher to cross against L1 ask while staying passive vs v3.

Smaller clip (LOT=3), max position 36, cooldown 20. Flatten at bid when regime off.
Same (csv_day, ts) trade index as v3/v4.
"""
