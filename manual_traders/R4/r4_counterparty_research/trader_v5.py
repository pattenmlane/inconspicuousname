"""
Round 4 MM — v5 = v2 + Phase-3 extract tilt **only when joint gate is tight**.

Phase 3 showed higher forward extract when 5200+5300 spreads are tight; v4 also widened/shrank
extract in the **loose** regime, which hurt ``--match-trades all``. v5 keeps **loose** extract
identical to trader_v2 (edge 3, size 8) and only applies the aggressive tight-regime schedule
(edge 0, size 24) when the gate is on.

VEV / hydro / Mark22-VEV logic unchanged from trader_v2.
"""
