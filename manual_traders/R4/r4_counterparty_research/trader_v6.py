"""
Round 4 MM — v6 = v5 with larger tight-regime extract size (parameter sweep).

v5: tight U edge 0 size 24; loose U same as v2 (3/8).
v6: tight U edge 0 size **28** (tests whether Phase-3 tilt can absorb more inventory risk).
"""
