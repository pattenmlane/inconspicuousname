"""
Round 4 MM — v7 = v5 with smaller tight-regime extract size (20 vs 24).

Hypothesis: v6 showed size 28 hurts; v7 tests whether slightly smaller tight-book extract
still captures Phase-3 drift with less inventory risk.
"""
