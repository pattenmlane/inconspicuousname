"""
Round 4 MM — v8 = v5 with conservative tight-regime extract edge (1 tick) and size 24.

v5 uses edge 0 in tight (maximum aggression). v8 uses edge 1 (same as VEV tight / v2 extract
tight baseline) with size 24 — tests whether one tick of cushion beats zero-edge lift.
"""
