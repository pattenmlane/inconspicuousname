"""
Round 4 MM — v9 = v5 + cross-product counterparty hedge on extract.

After any prior-tick VEV buy fill from passive Mark 22 (same detection as v2/v5 on VEVs),
also widen and shrink **VELVETFRUIT_EXTRACT** quotes for one tick (+1 edge, size floor 4).
Rationale: basket flow from Mark 22 may correlate with extract pressure; Phase 1 emphasized
Mark 22 on options; tape script r4_mark22_extract_roles_by_day.json quantifies M22 on U prints.

VEV strike-level widen unchanged from v5.
"""
...
class Trader:
    def run(self, state: TradingState):
        ...
        td["m22_pressure_widen_u"] = m22_pressure
