"""
Round 4 — **v6**: **v3** extract + **VEV_5300** only when joint tight (no **VEV_5200** quotes).

Hypothesis: basket flow concentrates on **5300**; **5200** may add noise or zero `worse`
fills without benefit.

Same constants as **v4** for extract and VEV half. **No HYDRO**, no other VEVs.
"""
