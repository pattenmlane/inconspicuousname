"""
Round 4 — **v9**: **v8** (joint gate: **v3** extract + **HYDROGEL_PACK** MM) + **v4** VEV legs
(**VEV_5200**, **VEV_5300** winged half vs extract mid).

Tests whether the **phase8** hydro add-on **composes** with the Sonic hedge surface from **v4**
without losing **`worse`** extract/hydro PnL.

**Requires** books: **VEV_5200**, **VEV_5300**, **VELVETFRUIT_EXTRACT**, **HYDROGEL_PACK** when tight.
"""
