#!/usr/bin/env python3
"""
Compare **pepper** PnL: ``round2work/r2_submission_target80.py`` (``PEPPER_TARGET_LONG=80``)
...
From repo root::
  ...
  python3 round2work/litests/compare_r2_target80_vs_potential1_pepper.py
"""
...
REPORT_DEFAULT = HERE / "r2_target80_vs_potential1_pepper_report.txt"
...
def main() -> None:
    ...
    ap.add_argument("--r2-module", type=str, default="r2_submission_target80")
    ...
    lines: list[str] = []
    w = lines.append
    w(f"Pepper PnL: {args.r2_module} vs potential1")
    w("=" * 90)
