"""Frozen copy of potential2 pepper-only **before** robustness edits (truthy mid/bid checks, etc.).

Used only for PnL regression vs ``round2submission/potential2_pepper_only.py``.
Do not edit for strategy changes — update the main file and refresh this snapshot if needed.
"""
