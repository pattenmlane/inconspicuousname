"""Osmium leg only, extracted from ``round2work/litests/potential3.py``.

MeanReversionMarketMaker (rolling mean window + Bayesian MU blend). See source for parameters.
``bid()`` returns 0 like current potential3.
"""
