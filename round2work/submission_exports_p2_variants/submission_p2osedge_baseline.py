"""Prosperity submission variant (osmium-only potential2).

p2osedge baseline: edge=1.0, PRIOR_STRENGTH=2000, eplison=0.65 (matches litests/potential2_osmium_only_edge1p0.py).

Source: round2work/litests/potential2_osmium_only*.py
"""
