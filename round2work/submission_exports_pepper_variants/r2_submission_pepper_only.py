"""Pepper-only extract of ``round2work/r2_submission.py``.

Drift-anchored Emerald MM (70 long / 80 cap) + rolling touch-mid slope crash
safeguard. Same constants and order logic as the submission pepper leg; no osmium.
"""
