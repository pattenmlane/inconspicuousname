...
Output: this folder (`test_implementation/wind_down/`). Uses `original_method/wind_down/combined_analysis`
(same as canonical winding `plot_iv_smile_round3`).

Run:  python3 round3work/plotting/test_implementation/wind_down/run_nb_method_plots.py
"""
...
_ORIG = _PLOT_DIR / "original_method" / "wind_down" / "combined_analysis"
